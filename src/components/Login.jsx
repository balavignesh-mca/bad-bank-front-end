...
import R from "../images/refresh.png";
...
console.log(storedToken)
  ...
  const loginAccount = async () => {
    ...
    try {
      const res = await axios.post("http://127.0.0.1:4000/login", data);
        ...
        <Card border="primary" className="form" style={addButton}>
          ...
          <Card.Body>
            <button
              ...
              style={{ float: "left" }}
              title="Reload account details"
              onClick={()=> setRefresh(true)}
            >
              <img src={R} width="20px" alt="Reload" />
            </button>
            <br />
            <h1
              style={{ fontSize: 40, paddingBottom: "1rem" }}
              className="title"
            >
              Account ID is: {data.custid}
            </h1>
            <h3
              style={{ fontSize: 30, paddingBottom: ".3rem" }}
              className="title"
            >
              Name: {data.name}
            </h3>
